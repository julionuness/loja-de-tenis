    ...
    return(
        ...
        <header>
          <Container>
            ...
            <h2 className="text-center">Tênis Vans SK8-HI X ONE PIECE PUNK HAZARD</h2>
          </Container>
        </header>
        <main>
          <Container>
            <Row>
              <Col md={7}>
                <Image  style={{ width: '30rem', height: '30rem'}} src="https://artwalk.vteximg.com.br/arquivos/ids/352773-1000-1000/7NS44-8-900-1.jpg?v=638110580532000000" />
              </Col>
              <Col md={5}>
                <p>ㅤ</p>
                <p>ㅤ</p>
