    ...
    return(
        ...
        <header>
          <Container>
            ...
            <h2 className="text-center">Tênis Puma Rise Nitro</h2>
          </Container>
        </header>
        <main>
          <Container>
            <Row>
              <Col md={7}>
                <Image  style={{ width: '30rem', height: '30rem'}} src="https://artwalk.vteximg.com.br/arquivos/ids/319543-1000-1000/37701-2-002-1.jpg?v=638060180878530000" />
              </Col>
              <Col md={5}>
                <p>ㅤ</p>
                <p>ㅤ</p>
