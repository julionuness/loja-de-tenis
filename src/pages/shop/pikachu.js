...
function Pikachu(){
    ...
    return(
        ...
        <header>
          <Container>
            <Image style={{ width: '5rem', height: '3rem'}} src="https://logodownload.org/wp-content/uploads/2014/07/puma-logo-1.png" />
            <h2 className="text-center">Tênis Puma RS-X Pikachu</h2>
          </Container>
        </header>
        <main>
          <Container>
            <Row>
              <Col md={7}>
                <Image  style={{ width: '30rem', height: '30rem'}} src="https://artwalk.vteximg.com.br/arquivos/ids/351924-1000-1000/38954-1-001-1.jpg?v=638101762769170000" />
              </Col>
              <Col md={5}>
                <p>ㅤ</p>
                <p>ㅤ</p>
