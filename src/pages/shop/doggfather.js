    ...
    return(
        ...
        <header>
          <Container>
            ...
            <h2 className="text-center">Tênis Jordan Doggfather</h2>
          </Container>
        </header>
        <main>
          <Container>
            <Row>
              <Col md={7}>
                <Image  style={{ width: '30rem', height: '30rem'}} src="https://artwalk.vteximg.com.br/arquivos/ids/372320-1000-1000/DO718-9-002-1.jpg?v=638162982467000000" />
              </Col>
              <Col md={5}>
                <p>ㅤ</p>
                <p>ㅤ</p>
