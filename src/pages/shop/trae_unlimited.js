    ...
    return(
        ...
        <header>
          <Container>
            ...
            <h2 className="text-center">Tênis Adidas Trae Unlimited</h2>
          </Container>
        </header>
        <main>
          <Container>
            <Row>
              <Col md={7}>
                <Image  style={{ width: '30rem', height: '30rem'}} src="https://artwalk.vteximg.com.br/arquivos/ids/363777-1000-1000/HQ102-0-001-1.jpg?v=638146736611600000" />
              </Col>
              <Col md={5}>
                <p>ㅤ</p>
                <p>ㅤ</p>
