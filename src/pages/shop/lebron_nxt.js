    ...
    return(
        ...
        <header>
          <Container>
            ...
            <h2 className="text-center">Tênis Nike Lebron NXTT Gen</h2>
          </Container>
        </header>
        <main>
          <Container>
            <Row>
              <Col md={7}>
                <Image  style={{ width: '30rem', height: '30rem'}} src="https://artwalk.vteximg.com.br/arquivos/ids/373282-1000-1000/DR878-4-002-1.jpg?v=638164693548130000" />
              </Col>
              <Col md={5}>
                <p>ㅤ</p>
                <p>ㅤ</p>
