...
function Airmax(){
    ...
    return(
        ...
        <header>
          <Container>
            <Image style={{ width: '6rem', height: '3rem'}} src="https://logosmarcas.net/wp-content/uploads/2020/04/Nike-Logo.png" />
            <h2 className="text-center">Tênis Nike Air Max 90 Futura</h2>
          </Container>
        </header>
        <main>
          <Container>
            <Row>
              <Col md={7}>
                <Image  style={{ width: '30rem', height: '30rem'}} src="https://artwalk.vteximg.com.br/arquivos/ids/363021-1000-1000/FD082-1-100-1.jpg?v=638144880475830000" />
              </Col>
              <Col md={5}>
                <p>ㅤ</p>
                <p>ㅤ</p>
